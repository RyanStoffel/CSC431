...
public class Lab_2 {
    ...
    void main() {
        ...
        sendBulkEmail(dotenv, recipients);
    }
        ...
        for (String recipient : recipients) {
            try {
                ...
                message.setFrom(
                    new InternetAddress(
                        dotenv.get("EMAIL_USERNAME"),
                        "Andy B. Vowell-bvowell@calbaptist.edu"
                    )
                );
                ...
                message.setSubject(
                    "2026-SP-UT GST050-A-Chapel Convocation: The THIRD CHAPEL of the Semester is CANCELLED"
                );
                ...
                String chapelScheduleLink =
                    "https://script.google.com/macros/s/AKfycbwCwotVhud5rhVjIfWqio7G2W_2nXPq0EjluQZgPIRkYK7mokjAr7q-SkWvQ0ui-a-yNg/exec?email=" +
                    encodedEmail;
